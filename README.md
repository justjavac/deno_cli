...
[![tag](https://img.shields.io/github/release/justjavac/deno_cli)](https://github.com/justjavac/deno_cli/releases)
[![Build Status](https://github.com/justjavac/deno_cli/workflows/ci/badge.svg?branch=master)](https://github.com/justjavac/deno_cli/actions)
[![license](https://img.shields.io/github/license/justjavac/deno_cli)](https://github.com/justjavac/deno_cli/blob/master/LICENSE)
...
[deno_cli](https://github.com/justjavac/deno_cli) is released under the MIT License. See the bundled [LICENSE](./LICENSE) file for details.
